...
class DeadCell: UITableViewCell {
    
    static let identifier = "dead_cell"
    
    lazy var image = DeadImage()
    
    private lazy var cellStateLabel: UILabel = {
        let state = UILabel()
        state.text = Strings.deadStateLabel
    ...
    private lazy var additionalLabel: UILabel = {
        ...
        additional.text = Strings.deadAdditionalLabel
