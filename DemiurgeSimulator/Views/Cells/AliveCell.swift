...
class AliveCell: UITableViewCell {
    
    static let identifier = "alive_cell"
    
    lazy var image = AliveImage()
    
    private lazy var cellStateLabel: UILabel = {
        let state = UILabel()
        state.text = Strings.aliveStateLabel
    ...
    private lazy var additionalLabel: UILabel = {
        ...
        additional.text = Strings.aliveAdditionalLabel
